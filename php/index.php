            ...
            <div class="row">
              <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="text-center">
                  <h3 class="text-white fw-bold mt-3">Doctor Handwritten Prescription Recognition</h3>
                </div>
              </div>
            </div>
            <div class="row">
              <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="centerDiv my-3">
                  <div class="card">
                    <form class="file-form" action="upload.php" method="post" , enctype="multipart/form-data">
                      <div class="card-body">
                        <div class="card-title">Upload your file here</div>
                        <img hidden id="output" src="" alt="" style="
                          width: 100%;
                          height: auto;
                      " />
                        <div id="outputs" class="file-upload">
                          <input class="file-input" type="file" , name="image" id="imageUpload">
                          <svg class="icon" id="icon" viewBox="0 0 60 60" xmlns="http://www.w3.org/2000/svg">
                          ...
                          <div class="card-subtitle" id="card-subtitle">
                            <span><i class="fas fa-cloud-upload-alt text-dark"></i></span>
