        ...
        <div class="container">
            ...
            <div id="navbar" class="collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li><a href="<?php echo base_url(); ?>ShowForm/create_medicine_name/main">Medicines</a>
                    </li>
                    ...
                    <li><a href="<?php echo base_url(); ?>ShowForm/manage_staff/main">Medicine Recommendation</a></li>
                    <li><a href="<?php echo base_url(); ?>ShowForm/profit_loss/main">OCR</a></li>
                </ul>
