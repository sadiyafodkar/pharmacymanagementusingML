                        ...
                        <div class="box-body">
                            <div class="row">
                                <div class="col-sm-2" style="">
                                    ...
                                    <input type="text" class="form-control datepicker" placeholder="Insert Date"
                                        name="date" id="date" value="<?php  echo date('Y-m-d'); ?>" autocomplete="off">
                                </div>
                                <div class="col-sm-3" style="">
                                    ...
                                    <input type="email" class="form-control" placeholder="Enter Email" name="customer_email"
                                        id="customer_email" autocomplete="off" required>
                                </div>
                                <div class="col-sm-7" style="">
                                    ...
                                    <select name="medicine_name" id="medicine_name" class="form-control selectpicker"
                                        ...
                                        <?php foreach ($all_value as $info) {
											...
											?>
                                        <option
                                            value="<?php echo $info->medicine_name_id."###".$info->medicine_name."###".$info->generic_name."###".$info->medicine_presentation; ?>">
                ...
                <div class="panel panel-default">
                    ...
                    <table id="salesList" class="table table-bordered table-hover">
                        ...
                        <tr>
                            ...
                            <td colspan="2">
                                Sub Total<input type="text" class="form-control" id="sub_total" value="0"
                                    style="color: black; border: black 2px solid;" name="sub_total" readonly>
                            </td>
                            <td colspan="2">
                                Pay<input type="number" class="form-control" id="pay" value="0"
